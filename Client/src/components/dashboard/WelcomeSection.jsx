...
import { Add, VideoCall, Phone, RequestQuote } from '@mui/icons-material'
...
const ACTIONS = [
  { label: 'Add Lead',        icon: <Add fontSize="small" />,          path: '/leads',      gradient: 'from-violet-600 to-indigo-600' },
  { label: 'Schedule Meeting',icon: <VideoCall fontSize="small" />,    path: '/meetings',   gradient: 'from-sky-500 to-cyan-500'      },
  { label: 'Create Follow Up',icon: <Phone fontSize="small" />,        path: '/follow-ups', gradient: 'from-emerald-500 to-teal-500'  },
  { label: 'Generate Quote',  icon: <RequestQuote fontSize="small" />, path: '/opportunities', gradient: 'from-orange-500 to-amber-500' },
]
...
export default function WelcomeSection() {
  ...
  const firstName = user?.name?.split(' ')[0] || 'Sales Exec'
  ...
  return (
    ...
    >
      ...
      <div className="relative flex flex-col md:flex-row md:items-center gap-6">
        ...
        >
          <p className="text-white/70 text-xs font-semibold uppercase tracking-wider mb-3">Monthly Target</p>
