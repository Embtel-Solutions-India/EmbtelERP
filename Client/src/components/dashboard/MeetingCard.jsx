                ...
                <div className="flex items-start justify-between gap-2">
                  <div className="min-w-0">
                    <div className="flex items-center gap-1.5 flex-wrap">
                      <span className="text-sm font-semibold text-neutral-800 dark:text-neutral-100">{meeting.client}</span>
                      <TypeIcon className={typeEntry.color} size={13} />
                    </div>
                    <div className="flex items-center gap-1.5 mt-0.5">
                      <span className="text-xs text-neutral-500 dark:text-neutral-400">{meeting.company}</span>
