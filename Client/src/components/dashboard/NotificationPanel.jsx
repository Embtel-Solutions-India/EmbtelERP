...
const TYPE_STYLES = {
  ...
  system:  { bg: 'bg-neutral-100 dark:bg-neutral-700/50',     Icon: FaCog,         iconCls: 'text-neutral-500 dark:text-neutral-400',     dot: 'bg-neutral-400'   },
}
          ...
          return (
            <motion.div
              ...
              className={`flex gap-3 p-3 rounded-xl cursor-pointer transition-all hover:scale-[1.01] ${
                !n.read ? `${style.bg} border border-current/10` : 'hover:bg-neutral-50 dark:hover:bg-neutral-700/40'
              }`}
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-start justify-between gap-2">
                  ...
                  <span className="text-xs text-neutral-400 dark:text-neutral-500 flex-shrink-0">{timeAgo(n.time)}</span>
                </div>
