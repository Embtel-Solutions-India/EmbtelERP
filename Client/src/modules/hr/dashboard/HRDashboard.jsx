...
import { fetchWorkspaceApprovals, fetchTeamLeaderboard, fetchWorkspaceActivities } from '../../../redux/slices/workspaceSlice'
...
export default function HRDashboard() {
  ...
  return (
    <div className="space-y-6 max-w-[1600px] mx-auto">
      ...
      {loading && <div className="text-center py-2 text-sm text-neutral-400">Loading HR data...</div>}
      ...
      <DashboardLayoutEngine role="hr_manager" />
    </div>
  )
}
