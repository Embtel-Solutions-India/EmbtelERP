...
import {
  fetchDashboardOverview, fetchDashboardPerformance, fetchDashboardInsights, fetchRoleWorkspace
} from '../../../redux/slices/dashboardSlice'
import { fetchTasks } from '../../../redux/slices/taskSlice'
import { fetchWorkspaceFollowUps, fetchTeamStats, fetchWorkspaceApprovals, fetchWorkspaceActivities } from '../../../redux/slices/workspaceSlice'
...
export default function ProductionDashboard() {
  ...
  const isManager = level >= 2 || designation.includes('manager')

  const roleKey = isManager ? 'documentation_manager' : 'documentation_executive'
